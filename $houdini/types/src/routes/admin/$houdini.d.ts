...
type LayoutRouteId = RouteId | "/admin/articles" | "/admin/menus" | "/admin/permissions" | "/admin/roles" | "/admin/users"
...
export type LayoutData = Expand<Expand<Omit<LayoutParentData, keyof Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/admin/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/admin/+layout.js').load>>>>>> & {  }>;
